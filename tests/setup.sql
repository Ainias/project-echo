...
insert into `region` set name='Köln', deleted=0, version=1, updatedAt='2019-04-04 19:01:59', id=1, createdAt='2019-02-02 18:00:00';
insert into `churchRegion` set churchId=1, regionId=1;