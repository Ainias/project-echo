...
var initSqlJs = function (moduleConfig) {
    ...
    initSqlJsPromise = new Promise(function (resolveModule, reject) {
                    ...
                    for (h = []; 0 !== x(D, 'i8'); ) {
                        ...
                        if (0 !== ja) {
                            ...
                            for (null != l && q.bind(l); q.step(); )
                                null === B && ((B = { columns: q.getColumnNames(), values: [] }), h.push(B)),
                                    B.values.push(q.get());
                            q.free();
                        }
                    }
                    ...
                    switch (typeof D) {
                        ...
                        case 'object':
                            null === D
                                ...
                                : rb(q, 'Wrong API use : tried to return a value of an unknown type (' + D + ').', -1);
                            break;
                        default:
                            qb(q);
                    }
        ...
        if (za)
            ...
            G ? (I = self.location.href) : document.currentScript && (I = document.currentScript.src),
                (I = 0 !== I.indexOf('blob:') ? I.substr(0, I.lastIndexOf('/') + 1) : ''),
                (Ba = function (a) {
        ...
        e.wasmMemory ? (Oa = e.wasmMemory) : (Oa = new WebAssembly.Memory({ initial: Za / 65536, maximum: 32768 }));
        Oa && (Xa = Oa.buffer);
        Za = Xa.byteLength;
        Ya(Xa);
        var $a = [],
                ...
                createNode: function (a, b, c, d) {
                    ...
                    P.Va ||
                        (P.Va = {
                            ...
                            link: { node: { Ua: P.Na.Ua, Ta: P.Na.Ta, readlink: P.Na.readlink }, stream: {} },
                    ...
                    Q(c.mode)
                        ...
                        : 32768 === (c.mode & 61440)
                        ? ((c.Na = P.Va.file.node), (c.Oa = P.Va.file.stream), (c.Sa = 0), (c.Ma = null))
                        : 40960 === (c.mode & 61440)
                        ? ((c.Na = P.Va.link.node), (c.Oa = P.Va.link.stream))
                        : 8192 === (c.mode & 61440) && ((c.Na = P.Va.ub.node), (c.Oa = P.Va.ub.stream));
            ...
            for (d = 0; d < a.length; d++) {
                ...
                if (!g || b.Ya)
                    for (g = 0; 40960 === (f.mode & 61440); )
                        if (((f = Tb(c)), (c = Eb(zb(c), f)), (f = V(c, { rb: b.rb }).node), 40 < g++)) throw new O(32);
            }
        ...
        function u(a, b, c, d) {
            ...
            b & 512 && mc(g, 0);
            b &= -131713;
            d = dc({ node: g, path: Ub(g), flags: b, seekable: !0, position: 0, Oa: g.Oa, Rb: [], error: !1 }, d);
            d.Oa.open && d.Oa.open(d);
            !e.logReadFiles ||
                b & 1 ||
                (Pc || (Pc = {}), a in Pc || ((Pc[a] = 1), J('FS.trackingDelegate error on read file: ' + a)));
            try {
                U.onOpenFile &&
                    ((g = 0), 1 !== (b & 2097155) && (g |= 1), 0 !== (b & 2097155) && (g |= 2), U.onOpenFile(a, g));
            } catch (n) {
        ...
        var id = {
            ...
            I: function (a, b) {
                try {
                    return (
                        (a = A(a)), (a = r(a)), '/' === a[a.length - 1] && (a = a.substr(0, a.length - 1)), W(a, b), 0
                    );
                } catch (c) {
                    return ('undefined' !== typeof X && c instanceof O) || K(c), -c.Pa;
                }
            ...
            function a() {
                if (!jd && ((jd = !0), (e.calledRun = !0), !Pa)) {
                    e.noFSInit ||
                        ...
                        e.stdout ? Vc('stdout', null, e.stdout) : ic('/dev/tty', '/dev/stdout'),
                        e.stderr ? Vc('stderr', null, e.stderr) : ic('/dev/tty1', '/dev/stderr'),
                        u('/dev/stdin', 'r'),
                        u('/dev/stdout', 'w'),
                        u('/dev/stderr', 'w'));
                    nb(ab);
