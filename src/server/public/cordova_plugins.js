cordova.define('cordova/plugin_list', function (require, exports, module) {
    module.exports = [
        ...
        },
        {
            ...
            clobbers: ['cordova.plugins.notification.local'],
        },
        {
            file: 'plugins/cordova-plugin-local-notification/www/local-notification-core.js',
            id: 'cordova-plugin-local-notification.LocalNotification.Core',
            pluginId: 'cordova-plugin-local-notification',
            clobbers: ['cordova.plugins.notification.local.core', 'plugin.notification.local.core'],
        },
        {
            file: 'plugins/cordova-plugin-local-notification/www/local-notification-util.js',
            id: 'cordova-plugin-local-notification.LocalNotification.Util',
            pluginId: 'cordova-plugin-local-notification',
            merges: ['cordova.plugins.notification.local.core', 'plugin.notification.local.core'],
        },
        {
            file: 'plugins/cordova-plugin-background-fetch/www/BackgroundFetch.js',
            id: 'cordova-plugin-background-fetch.BackgroundFetch',
            pluginId: 'cordova-plugin-background-fetch',
            clobbers: ['window.BackgroundFetch'],
        },
    ];
