        ...
        var cordova = {
            ...
            callbackFromNative: function (callbackId, isSuccess, status, args, keepCallback) {
                ...
                */
                    ...
                    var msg =
                        'Error in ' + (isSuccess ? 'Success' : 'Error') + ' callbackId: ' + callbackId + ' : ' + err;
            ...
            var xhrStatusChangeHandler = function () {
                if (xhr.readyState == 4) {
                    if (xhr.status == 200 || xhr.status == 304 || xhr.status === 0 /* file:// */) {
                        ...
                        fail(
                            '[Browser][cordova.js][xhrStatusChangeHandler] Could not XHR config.xml: ' + xhr.statusText
                        );
                    }
                }
            };
        ...
        module.exports = function (success, fail, service, action, args) {
            ...
            if (proxy) {
                ...
                try {
                    ...
                    console.log(
                        'Exception calling native with command :: ' + service + ' :: ' + action + ' ::exception=' + e
                    );
                }
            } else {
