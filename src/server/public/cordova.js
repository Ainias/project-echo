...
var cordova = require('src/server/public/cordova');
...
channel.join(function () {
    ...
    // side.
    channel.join(function () {
        require('src/server/public/cordova').fireDocumentEvent('deviceready');
...
window.cordova = require('src/server/public/cordova');
