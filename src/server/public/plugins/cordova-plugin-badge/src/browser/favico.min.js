cordova.define('cordova-plugin-badge.Badge.Favico', function (require, exports, module) {
     ...
     */ !(function () {
        var e = function (e) {
            ...
            (x = {}),
                (x.ff = 'undefined' != typeof InstallTrigger),
                (x.chrome = !!window.chrome),
                (x.opera = !!window.opera || navigator.userAgent.indexOf('Opera') >= 0),
                (x.ie = /*@cc_on!@*/ !1),
                (x.safari = Object.prototype.toString.call(window.HTMLElement).indexOf('Constructor') > 0),
                (x.supported = x.chrome || x.ff || x.opera);
            var C = [];
            (w = function () {}), (d = g = !1);
            var E = function () {
                    (i = n(v, e)),
                        (i.bgColor = o(i.bgColor)),
                        (i.textColor = o(i.textColor)),
                        (i.position = i.position.toLowerCase()),
                        (i.animation = S.types['' + i.animation] ? i.animation : v.animation),
                        (b = i.win.document);
                    ...
                    if (t || r)
                        for (var d = 0; d < S.types['' + i.animation].length; d++) {
                            ...
                            t && (u.y = u.y < 0.6 ? u.y - 0.4 : u.y - 2 * u.y + (1 - u.w)),
                                r && (u.x = u.x < 0.6 ? u.x - 0.4 : u.x - 2 * u.x + (1 - u.h)),
                                (S.types['' + i.animation][d] = u);
                        }
                    (i.type = A['' + i.type] ? i.type : v.type),
                        (a = O.getIcon()),
                        ...
                        a.hasAttribute('href')
                            ? (c.setAttribute('crossOrigin', 'anonymous'),
                              (c.onload = function () {
                                  (l = c.height > 0 ? c.height : 32),
                                      (s = c.width > 0 ? c.width : 32),
                                      (h.height = l),
                                      (h.width = s),
                                      (f = h.getContext('2d')),
                                      M.ready();
            ...
            (A.circle = function (e) {
                ...
                var t = !1;
                2 === e.len
                    ? ((e.x = e.x - 0.4 * e.w), (e.w = 1.4 * e.w), (t = !0))
                    : e.len >= 3 && ((e.x = e.x - 0.65 * e.w), (e.w = 1.65 * e.w), (t = !0)),
                    f.clearRect(0, 0, s, l),
                    f.drawImage(c, 0, 0, s, l),
                    f.beginPath(),
                    (f.font = i.fontStyle + ' ' + Math.floor(e.h * (e.n > 99 ? 0.85 : 1)) + 'px ' + i.fontFamily),
                    (f.textAlign = 'center'),
                    t
                        ? (f.moveTo(e.x + e.w / 2, e.y),
                          f.lineTo(e.x + e.w - e.h / 2, e.y),
                          f.quadraticCurveTo(e.x + e.w, e.y, e.x + e.w, e.y + e.h / 2),
                          f.lineTo(e.x + e.w, e.y + e.h - e.h / 2),
                          f.quadraticCurveTo(e.x + e.w, e.y + e.h, e.x + e.w - e.h / 2, e.y + e.h),
                          f.lineTo(e.x + e.h / 2, e.y + e.h),
                          f.quadraticCurveTo(e.x, e.y + e.h, e.x, e.y + e.h - e.h / 2),
                          f.lineTo(e.x, e.y + e.h / 2),
                          f.quadraticCurveTo(e.x, e.y, e.x + e.h / 2, e.y))
                        : f.arc(e.x + e.w / 2, e.y + e.h / 2, e.h / 2, 0, 2 * Math.PI),
                    (f.fillStyle = 'rgba(' + i.bgColor.r + ',' + i.bgColor.g + ',' + i.bgColor.b + ',' + e.o + ')'),
                    f.fill(),
                    f.closePath(),
                    f.beginPath(),
                    f.stroke(),
                    (f.fillStyle =
                        'rgba(' + i.textColor.r + ',' + i.textColor.g + ',' + i.textColor.b + ',' + e.o + ')'),
                    'number' == typeof e.n && e.n > 999
                        ...
                        : f.fillText(e.n, Math.floor(e.x + e.w / 2), Math.floor(e.y + e.h - 0.15 * e.h)),
                    f.closePath();
            }),
                (A.rectangle = function (e) {
                    ...
                    2 === e.len
                        ...
                        f.drawImage(c, 0, 0, s, l),
                        f.beginPath(),
                        (f.font = i.fontStyle + ' ' + Math.floor(e.h * (e.n > 99 ? 0.9 : 1)) + 'px ' + i.fontFamily),
                        (f.textAlign = 'center'),
                        (f.fillStyle = 'rgba(' + i.bgColor.r + ',' + i.bgColor.g + ',' + i.bgColor.b + ',' + e.o + ')'),
                        f.fillRect(e.x, e.y, e.w, e.h),
                        (f.fillStyle =
                            'rgba(' + i.textColor.r + ',' + i.textColor.g + ',' + i.textColor.b + ',' + e.o + ')'),
                        'number' == typeof e.n && e.n > 999
                            ? f.fillText(
                            ...
                            try {
                                if ('number' == typeof e ? e > 0 : '' !== e) {
                                    ...
                                    if (
                                        ...
                                        'type' in t && A['' + t.type] && (n.options.type = '' + t.type),
            ...
            (O.getIcon = function () {
                var e = !1,
                    t = function () {
                        for (
                            var e = b.getElementsByTagName('head')[0].getElementsByTagName('link'),
                                t = e.length,
                                o = t - 1;
                            o >= 0;
                            o--
                ...
                return (
                    i.element
                        ? (e = i.element)
                        : i.elementId
                        ? ((e = b.getElementById(i.elementId)), e.setAttribute('href', e.getAttribute('src')))
                        : ((e = t()),
                          e === !1 &&
                ...
                (O.setIcon = function (e) {
                    ...
                    if ((i.dataUrl && i.dataUrl(t), i.element))
                        ...
                        (a = b.createElement('link')),
                            x.opera && a.setAttribute('rel', 'icon'),
            ...
            return (
                ...
                (S.run = function (e, t, o, a) {
                    ...
                    return (
                        (a = o === !0 ? ('undefined' != typeof a ? a : l.length - 1) : 'undefined' != typeof a ? a : 0),
                        (t = t ? t : function () {}),
                        a < l.length && a >= 0
                            ? (A[i.type](n(e, l[a])),
                ...
                E(),
                { badge: T, video: R, image: U, webcam: L, reset: M.reset, browser: { supported: x.supported } }
            );
        };
