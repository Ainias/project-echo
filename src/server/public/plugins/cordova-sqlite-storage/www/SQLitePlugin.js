       ...
       */
        ...
        SQLitePluginTransaction.prototype.addStatement = function (sql, values, success, error) {
            ...
            if (!!values && values.constructor === Array) {
                for (j = 0, len1 = values.length; j < len1; j++) {
                    ...
                    t = typeof v;
                    params.push(
                        v === null || v === void 0 ? null : t === 'number' || t === 'string' ? v : v.toString()
                    );
                }
            }
            this.executes.push({
        ...
        SQLitePluginTransaction.prototype.run = function () {
            ...
            mycb = function (result) {
                ...
                for (
                    resultIndex = j = 0, ref = result.length - 1;
                    0 <= ref ? j <= ref : j >= ref;
                    resultIndex = 0 <= ref ? ++j : --j
                ) {
     ...
     */
            openDatabase: argsArray(function (args) {
                ...
                if (!!openargs.location && !!openargs.iosDatabaseLocation) {
                    throw newSQLError(
                        'AMBIGUOUS: both location and iosDatabaseLocation settings are present in openDatabase call. Please use either setting, not both.'
                    );
                }
                dblocation =
                ...
                if (!!openargs.androidDatabaseProvider && !!openargs.androidDatabaseImplementation) {
                    throw newSQLError(
                        'AMBIGUOUS: both androidDatabaseProvider and deprecated androidDatabaseImplementation settings are present in openDatabase call. Please drop androidDatabaseImplementation in favor of androidDatabaseProvider.'
                    );
                }
                if (
                    openargs.androidDatabaseProvider !== void 0 &&
                    openargs.androidDatabaseProvider !== 'default' &&
            ...
            deleteDatabase: function (first, success, error) {
                ...
                if (!first.iosDatabaseLocation && !first.location && first.location !== 0) {
                    throw newSQLError(
                        'Database location or iosDatabaseLocation setting is now mandatory in deleteDatabase call.'
                    );
                }
                if (!!first.location && !!first.iosDatabaseLocation) {
                    throw newSQLError(
                        'AMBIGUOUS: both location and iosDatabaseLocation settings are present in deleteDatabase call. Please use either setting value, not both.'
                    );
                }
                dblocation =
                    !!first.location && first.location === 'default'
                        ? iosLocationMap['default']
                        : !!first.iosDatabaseLocation
                ...
                SQLiteFactory.openDatabase(
                    ...
                    function (db) {
                        ...
                        db.transaction(
                            function (tx) {
                                tx.executeSql(
                                    'SELECT UPPER("Test") AS upperText',
                                    [],
                                    function (ignored, resutSet) {
                                        if (!resutSet.rows) {
                                        ...
                                        if (resutSet.rows.length !== 1) {
                                            return SelfTest.finishWithError(
                                                errorcb,
                                                'Incorrect resutSet.rows.length value: ' +
                                                    resutSet.rows.length +
                                                    ' (expected: 1)'
                                            );
                                        }
                                        ...
                                        if (resutSet.rows.item(0).upperText !== 'TEST') {
                                            return SelfTest.finishWithError(
                                                errorcb,
                                                'Incorrect resutSet.rows.item(0).upperText value: ' +
                                                    resutSet.rows.item(0).upperText +
                                                    " (expected: 'TEST')"
                                            );
                                        }
                                        check1 = true;
                                ...
                                return db.executeSql(
                                    ...
                                    function (resutSet) {
                                        ...
                                        if (resutSet.rows.item(0).data !== 'test-value') {
                                            SelfTest.finishWithError(
                                                errorcb,
                                                'Incorrect resutSet.rows.item(0).data value: ' +
                                                    resutSet.rows.item(0).data +
                                                    " (expected: 'test-value')"
                                            );
                                            return;
                                        }
                                        return db.transaction(
                                            ...
                                            function (tx_err) {
                                                return SelfTest.finishWithError(
                                                    errorcb,
                                                    'UPDATE transaction error: ' + tx_err
                                                );
                                            },
                                            function () {
                                                ...
                                                return db.readTransaction(
                                                    function (tx2) {
                                                        return tx2.executeSql(
                                                            'SELECT id, data FROM TestTable',
                                                            [],
                                                            function (ignored, resutSet2) {
                                                                if (!resutSet2.rows) {
                                                                ...
                                                                if (resutSet2.rows.length !== 1) {
                                                                    throw newSQLError(
                                                                        'Incorrect resutSet2.rows.length value: ' +
                                                                            resutSet2.rows.length +
                                                                            ' (expected: 1)'
                                                                    );
                                                                }
                                                                ...
                                                                if (resutSet2.rows.item(0).id !== firstid) {
                                                                    throw newSQLError(
                                                                        'resutSet2.rows.item(0).id value ' +
                                                                            resutSet2.rows.item(0).id +
                                                                            ' does not match previous primary key id value (' +
                                                                            firstid +
                                                                            ')'
                                                                    );
                                                                }
                                                                if (!resutSet2.rows.item(0).data) {
                                                                    throw newSQLError(
                                                                        'Missing resutSet2.rows.item(0).data'
                                                                    );
                                                                }
                                                                if (resutSet2.rows.item(0).data !== 'new-value') {
                                                                    throw newSQLError(
                                                                        'Incorrect resutSet2.rows.item(0).data value: ' +
                                                                            resutSet2.rows.item(0).data +
                                                                            " (expected: 'test-value')"
                                                                    );
                                                                }
                                                    ...
                                                    function () {
                                                        if (!readTransactionFinished) {
                                                            SelfTest.finishWithError(
                                                                errorcb,
                                                                'readTransaction did not finish'
                                                            );
                                                            return;
                                                        }
                                                        return db.transaction(
                                                            ...
                                                            function (tx3_err) {
                                                                return SelfTest.finishWithError(
                                                                    errorcb,
                                                                    'DELETE transaction error: ' + tx3_err
                                                                );
                                                            },
                                                            function () {
                                                                ...
                                                                return db.readTransaction(
                                                                    function (tx4) {
                                                                        return tx4.executeSql(
                                                                            'SELECT id, data FROM TestTable',
                                                                            [],
                                                                            function (ignored, resutSet3) {
                                                                                if (!resutSet3.rows) {
                                                                                    throw newSQLError(
                                                                                        'Missing resutSet3.rows'
                                                                                    );
                                                                                }
                                                                                if (!resutSet3.rows.length) {
                                                                                    throw newSQLError(
                                                                                        'Missing resutSet3.rows.length'
                                                                                    );
                                                                                }
                                                                                if (resutSet3.rows.length !== 1) {
                                                                                    throw newSQLError(
                                                                                        'Incorrect resutSet3.rows.length value: ' +
                                                                                            resutSet3.rows.length +
                                                                                            ' (expected: 1)'
                                                                                    );
                                                                                }
                                                                                ...
                                                                                if (
                                                                                    ...
                                                                                    throw newSQLError(
                                                                                        'resutSet3.rows.item(0).id value ' +
                                                                                            resutSet3.rows.item(0).id +
                                                                                            ' incorrectly matches previous unique key id value value (' +
                                                                                            firstid +
                                                                                            ')'
                                                                                    );
                                                                                }
                                                                                if (!resutSet3.rows.item(0).data) {
                                                                                    throw newSQLError(
                                                                                        'Missing resutSet3.rows.item(0).data'
                                                                                    );
                                                                                }
                                                                                if (
                                                                                    resutSet3.rows.item(0).data !== 123
                                                                                ) {
                                                                                    throw newSQLError(
                                                                                        'Incorrect resutSet3.rows.item(0).data value: ' +
                                                                                            resutSet3.rows.item(0)
                                                                                                .data +
                                                                                            ' (expected 123)'
                                                                                    );
                                                                                }
                                                                    ...
                                                                    function (tx4_err) {
                                                                        return SelfTest.finishWithError(
                                                                            errorcb,
                                                                            'second readTransaction error: ' + tx4_err
                                                                        );
                                                                    },
                                                                    function () {
                                                                        if (!secondReadTransactionFinished) {
                                                                            SelfTest.finishWithError(
                                                                                errorcb,
                                                                                'second readTransaction did not finish'
                                                                            );
                                                                            return;
                                                                        }
                                                                        db.close(
                                                                            function () {
                                                                                SelfTest.cleanupAndFinish(
                                                                                    successcb,
                                                                                    errorcb
                                                                                );
                                                                            },
